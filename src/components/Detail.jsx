...
const Detail = () => {
  ...
  if (!restaurant)
    return (
      <div
        className={`flex justify-center items-center min-h-screen w-full ${theme === "dark" ? "bg-[#111] text-white" : "bg-white text-black"
          }`}
      >
  ...
  return (
    <div
      className={`min-h-screen w-full ${theme === "dark" ? "bg-[#111] text-white" : "bg-white text-black"
        }`}
    >
      <div className="max-w-6xl mx-auto p-5">

        <div
          className={`w-full h-72 overflow-hidden flex rounded-2xl shadow-md relative ${theme === "dark" ? "bg-[#111] text-white" : "bg-white text-black"
            }`}
        >
          <LazyLoadImage
        ...
        <div
          className={`mt-10 p-6 rounded-2xl shadow-md ${theme === "dark" ? "bg-[#111] text-white" : "bg-white text-black"
            }`}
        >
          <h2 className="text-2xl font-bold mb-4">Recommended Items</h2>

          <div
            className={`grid sm:grid-cols-2 gap-6 ${theme === "dark" ? "bg-[#111] text-white" : "bg-white text-black"
              }`}
          >
            {restaurant.menu?.map((item, index) => {
              ...
              return (
                <div
                  key={index}
                  className={`border rounded-xl p-4 shadow-sm hover:shadow-lg transition relative ${theme === "dark" ? "bg-[#111] text-white" : "bg-white text-black"
                    }`}
                >
                  <button
                  ...
                  {qty === 0 ? (
                    ...
                    <div
                      className={`mt-3 flex items-center justify-between py-2 rounded px-3 ${theme === "dark"
